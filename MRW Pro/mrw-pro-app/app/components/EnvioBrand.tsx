...
/**
 * EnvioBrand — Branded header component for MRW Pro by Enviox
 * Shows the Enviox wordmark + "MRW Pro" badge
 * Use this in page headers and onboarding screens
 */
...
/** Main brand header: ENVIOX [MRW Pro] */
export function EnvioBrandHeader({ size = "default" }: { size?: "small" | "default" | "large" }) {
  ...
  return (
    <div style={BRAND_STYLES.container}>
      ...
      >
        MR<span style={BRAND_STYLES.badgeW}>W</span> Pro
      </span>
    </div>
  );
}
...
/** Brand divider — a thin gradient line */
