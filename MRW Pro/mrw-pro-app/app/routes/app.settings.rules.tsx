 ...
 * Automatically assign MRW service based on conditions:
 * - Weight range
 * - Postal code (prefix)
 * - Order total range
 * - Province
...
export default function ShippingRulesPage() {
  ...
  return (
    <Page
      ...
      subtitle="Asigna automáticamente el servicio MRW según las condiciones del pedido"
            ...
            <Card>
              <BlockStack gap="400">
                ...
                <Text as="p" variant="bodySm" tone="subdued">
                  Añade reglas para automatizar la asignación de servicio MRW:
                </Text>
        ...
        >
          <Modal.Section>
            <FormLayout>
              ...
              <Select
                label="Entonces usar servicio MRW:"
                options={services}
