...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (intent === "printBulk") {
    ...
    // 1. Call MRW API to get labels for each shipment
                ...
                <BlockStack gap="100">
                  ...
                  <Box paddingBlockStart="200">
                    <Text as="p" variant="bodySm" tone="subdued">
                      💡 Con la API MRW conectada, se generará un PDF combinado con todas las etiquetas listas para imprimir.
                    </Text>
                  </Box>
                </BlockStack>
              )}
