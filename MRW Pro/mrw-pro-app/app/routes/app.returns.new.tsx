              ...
              <BlockStack gap="600" inlineAlign="center">
                ...
                <Text as="p" variant="bodySm" tone="subdued" alignment="center">
                  {returnMethod === "pickup"
                    ...
                    : "El cliente puede llevar el paquete a cualquier punto MRW con la etiqueta."}
                </Text>
      ...
      <Page title="Crear devolución" backAction={{ url: "/app/returns" }}>
        <Layout>
          <Layout.Section>
            ...
            >
              Necesitas verificar tus credenciales MRW antes de crear devoluciones.
            </Banner>
          </Layout.Section>
        </Layout>
      </Page>
            ...
            <BlockStack gap="500">
              ...
              <Card>
                <BlockStack gap="400">
                  ...
                  >
                    <RadioButton
                      label="Generar etiqueta de devolución MRW (el cliente lleva a punto MRW)"
