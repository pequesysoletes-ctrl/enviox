...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (!credentials?.verified) {
    return json({ error: "Credenciales Correos no configuradas" }, { status: 400 });
  }
  ...
  try {
    ...
    const shipmentData: ShipmentData = {
      ...
      codigoServicio: serviceCode || "S0133",
    ...
    await prisma.shipment.create({
      data: {
        ...
        correosServiceCode: serviceCode || "S0133",
...
export default function NewShipment() {
  ...
  const [serviceCode, setServiceCode] = useState(config?.defaultService || "S0133");
    ...
    return (
      <Page title="Crear envío manual" backAction={{ url: "/app/shipments" }}>
        <Layout>
          <Layout.Section>
            <Banner
              title="Conecta tu cuenta Correos primero"
              tone="warning"
              action={{ content: "Conectar Correos", url: "/app/settings/correos" }}
            >
              Necesitas verificar tus credenciales Correos antes de crear envíos.
            </Banner>
          </Layout.Section>
        </Layout>
      </Page>
  ...
  const serviceOptions = [
    { name: "Paq Premium (24-48h)", code: "S0132", price: "5,90€", delivery: "24-48h" },
    { name: "Paq Estándar (48-72h)", code: "S0133", price: "4,50€", delivery: "48-72h" },
    { name: "Paq Today (mismo día)", code: "S0148", price: "12,50€", delivery: "Mismo día" },
    { name: "ePaq24 (eCommerce 24h)", code: "S0236", price: "4,90€", delivery: "24h" },
  ];
