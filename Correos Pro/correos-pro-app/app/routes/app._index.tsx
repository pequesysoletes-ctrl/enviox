...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  for (const s of allShipments) {
    const code = s.correosServiceCode || "0800";
  ...
  const serviceNames: Record<string, string> = {
    ...
    "S0133": "Paq Estándar",
    "S0148": "Paq Today",
    "S0175": "Paq Empresa 14",
    "S0176": "Paq Retorno",
    "S0177": "Paq Empresa",
    "S0178": "CityPaq",
    "S0235": "Paquetería Oficina",
    "S0236": "ePaq24",
  };
            ...
            <Card>
              <BlockStack gap="500" inlineAlign="center">
                ...
                <Text as="h1" variant="headingXl" alignment="center">
                  Bienvenido a Correos Pro
                </Text>
                <Text as="p" variant="bodyLg" alignment="center">
                  Automatiza tus envíos con Correos directamente desde Shopify
                </Text>
                ...
                <BlockStack gap="400">
                  <InlineStack gap="400" align="center">
                    <StepItem number={1} title="Conecta" description="Introduce tus credenciales Correos" active />
                ...
                <Text as="p" variant="bodyMd" alignment="center" tone="subdued">
                  Esta app conecta con tu contrato Correos Ecommerce. Necesitas las credenciales API de tu cuenta de empresa en Correos.
                </Text>

                <Button variant="primary" size="large" onClick={() => navigate("/app/settings/correos")}>
                  Conectar cuenta Correos
                </Button>

                <Button variant="plain" onClick={() => navigate("/app/settings/correos")}>
                  ¿Dónde encuentro mis credenciales Correos?
                </Button>
                <EnvioBrandFooter />
              </BlockStack>
            </Card>
    ...
    return (
      <Page title="Dashboard">
        <Layout>
          <Layout.Section>
            <Banner
              title="⚠ Verifica tu conexión Correos para empezar a crear envíos"
              tone="warning"
              action={{ content: "Verificar ahora", onAction: () => navigate("/app/settings/correos") }}
            />
          </Layout.Section>
        </Layout>
      </Page>
