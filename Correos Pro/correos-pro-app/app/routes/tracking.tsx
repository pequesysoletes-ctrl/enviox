 ...
 * This page is served as an App Proxy by Shopify at: tutienda.com/a/correos/tracking
 */
  ...
  return (
    <html lang="es">
      <head>
        ...
        <title>
          {shipment
            ? `Seguimiento ${shipment.correosTrackingNumber} — Correos Pro`
            : "Seguimiento de envío — Correos Pro by Enviox"
          }
        </title>
          ...
          <header className="tracking-header">
            <div className="header-content">
              <div className="brand">
                ...
                <span className="brand-badge">CORREOS PRO</span>
              </div>
          ...
          <section className="search-section">
            <form method="GET" className="search-form">
              <input
                type="text"
                name="n"
                placeholder="Introduce tu número de seguimiento Correos..."
                value={inputValue}
          ...
          <main className="tracking-main">
                ...
                <div className="details-grid">
                  <div className="detail-card">
                    ...
                    <div className="detail-row">
                      ...
                      <span className="detail-value">{SERVICE_NAMES[shipment.correosServiceCode || "S0133"] || "Paq Estándar"}</span>
                    </div>
                    <div className="detail-row">
            ...
            {!trackingNumber && (
              <div className="welcome">
                ...
                <h2>Rastrea tu envío Correos</h2>
