...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  if (credentials?.verified && shipment.mrwTrackingNumber) {
    const auth: MrwAuth = {
    ...
    const trackingResult = await getTracking(auth, shipment.mrwTrackingNumber);
    if (trackingResult.success) {
      mrwEvents = trackingResult.events;
    }

    const labelResult = await getLabel(auth, shipment.mrwTrackingNumber);
...
export default function ShipmentDetail() {
  ...
  const downloadLabel = () => {
    ...
    a.href = url;
    a.download = `etiqueta-${shipment.mrwTrackingNumber || shipment.id}.pdf`;
    a.click();
            ...
            <Box paddingBlockEnd="400">
              <Card background="bg-surface-info">
                <InlineStack align="space-between" blockAlign="center">
                  <BlockStack gap="100">
                    <Text as="p" variant="bodySm" tone="subdued">TRACKING MRW</Text>
        ...
        <Layout.Section variant="oneThird">
          ...
          <Card>
            <BlockStack gap="400" inlineAlign="center">
              <Text as="h2" variant="headingMd">🏷️ Etiqueta MRW</Text>
              ...
              {labelBase64 ? (
                ...
                <Box padding="400">
                  <Text as="p" variant="bodyMd" tone="subdued" alignment="center">
                    La etiqueta estará disponible cuando MRW procese el envío.
                  </Text>
                </Box>
              )}
            </BlockStack>
            ...
            <Card>
              <BlockStack gap="400">
                ...
                {timelineEvents.length > 0 ? (
                  ...
                  <Box padding="400">
                    <Text as="p" variant="bodySm" tone="subdued" alignment="center">
                      Sin eventos todavía. Se actualizará cuando MRW procese el envío.
                    </Text>
                  </Box>
                )}
              </BlockStack>
