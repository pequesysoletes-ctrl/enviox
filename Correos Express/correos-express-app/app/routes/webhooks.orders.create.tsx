...
import { createShipment, type MrwAuth, type ShipmentData } from "../services/correos.server";

/**
 * Webhook: orders/create
 * Auto-creates Correos Express shipment when new order comes in
  ...
  try {
    ...
    const shipment = await prisma.shipment.create({
      data: {
        ...
        correosTrackingNumber: result.success ? (result.trackingNumber || null) : null,
        correosServiceCode: shipmentData.codigoServicio,
        ...
        error: result.success ? null : (result.error || "Error de la API Correos"),
      },
    });
