            ...
            <Box paddingBlockEnd="400">
              <Card background="bg-surface-info">
                <InlineStack align="space-between" blockAlign="center">
                  <BlockStack gap="100">
                    <Text as="p" variant="bodySm" tone="subdued">TRACKING CORREOS EXPRESS</Text>
        ...
        <Layout.Section variant="oneThird">
          ...
          <Card>
            <BlockStack gap="400" inlineAlign="center">
              <Text as="h2" variant="headingMd">🏷️ Etiqueta Correos Express</Text>
              ...
              {labelBase64 ? (
                ...
                <Box padding="400">
                  <Text as="p" variant="bodyMd" tone="subdued" alignment="center">
                    La etiqueta estará disponible cuando Correos Express Procese el envío.
                  </Text>
                </Box>
              )}
            </BlockStack>
            ...
            <Card>
              <BlockStack gap="400">
                ...
                {timelineEvents.length > 0 ? (
                  ...
                  <Box padding="400">
                    <Text as="p" variant="bodySm" tone="subdued" alignment="center">
                      Sin eventos todavía. Se actualizará cuando Correos Express Procese el envío.
                    </Text>
                  </Box>
                )}
              </BlockStack>
