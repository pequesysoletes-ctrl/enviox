...
export default function NotificationSettingsPage() {
  ...
  const statusEvents = [
    ...
    { key: "notifyOnPickedUp", label: "🚛 Recogido", desc: "Cuando Correos Express recoge el paquete" },
  ...
  return (
    ...
    >
      <Layout>
        ...
        <Layout.Section>
          <Banner tone="success" title="🎉 ¡WhatsApp Tracking — Exclusiva Correos Express Pro!">
            <p>
                  ...
                  <BlockStack gap="200">
                    ...
                    <Box padding="300" background="bg-surface" borderRadius="200" borderWidth="025" borderColor="border">
                      <Text as="p" variant="bodySm">
                        🏠 Tu Tienda: ¡Tu envío CE-0123456789 sale hoy para entrega! Estate atento.
                        Seguimiento: https://enviox.es/tracking?n=CE-0123456789
                      </Text>
                    </Box>
                    ...
                    <Box padding="300" borderRadius="200" borderWidth="025" borderColor="border">
                      <div style={{ background: "#DCF8C6", borderRadius: 8, padding: 12, fontSize: 13 }}>
                        ...
                        <p style={{ margin: "8px 0 0 0" }}>
                          ¡Buenas noticias, Juan! Tu envío <strong>CE-0123456789</strong> <strong>sale hoy para entrega</strong>.
                        </p>
                        <p style={{ margin: "8px 0 0 0" }}>
