 ...
 * - Correos Express API: GET /puntos-servicio to search points by CP/city
...
// Mock pickup points for development (real ones come from Correos Express API)
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (intent === "search") {
    ...
    // In production: call Correos Express API to search pickup points
...
export default function PickupPointsPage() {
  ...
  return (
    <Page
      title="Oficinas Correos"
      subtitle="Permite a tus clientes recoger sus pedidos en oficinas Correos cercanos"
    ...
    >
      <Layout>
            ...
            <BlockStack gap="400">
              <InlineStack align="space-between" blockAlign="center">
                <BlockStack gap="100">
                  ...
                  <Text as="p" variant="bodySm" tone="subdued">
                    Cuando está activado, los clientes pueden elegir recoger su pedido en un oficina Correos cercano
              ...
              <Banner tone="info">
                <p>
                  ...
                  la API de Correos para consultar puntos de servicio.
                </p>
              </Banner>
            </BlockStack>
          </Card>
          ...
          <Card>
            <BlockStack gap="400">
              ...
              <InlineStack gap="400" wrap>
                {[
                  { step: "1", title: "Checkout", desc: "El cliente elige 'Recoger en oficina Correos' en el checkout", icon: "🛒" },
                  { step: "2", title: "Buscar", desc: "Introduce su CP y ve los oficinas Correos más cercanos", icon: "🔍" },
                  { step: "3", title: "Elegir", desc: "Selecciona su punto favorito con horario y mapa", icon: "📍" },
                  { step: "4", title: "Recoger", desc: "Recoge el paquete en el oficina Correos con su DNI", icon: "📦" },
                ].map((s) => (
        ...
        <Layout.Section>
          <Card>
            <BlockStack gap="400">
              <Text as="h2" variant="headingMd">🔍 Buscar oficinas Correos</Text>
              <Text as="p" variant="bodySm" tone="subdued">
              ...
              {actionData?.success && points.length === 0 && (
                <Banner tone="warning">
                  <p>No se encontraron oficinas Correos para "{actionData?.query}". Prueba con otro código postal.</p>
                </Banner>
              )}
            </BlockStack>
          </Card>
        ...
        <Layout.Section variant="oneThird">
          <Card>
            <BlockStack gap="300">
              <Text as="h2" variant="headingMd">📊 Red Correos</Text>
