 ...
 * This page is served as an App Proxy by Shopify at: tutienda.com/a/correos-express/tracking
 */
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const shipment = await prisma.shipment.findFirst({
    where: { correosTrackingNumber: trackingNumber },
    select: {
      id: true,
      ...
      destinationZip: true,
      correosTrackingNumber: true,
      correosServiceCode: true,
      status: true,
      weight: true,
      packages: true,
      createdAt: true,
  ...
  return (
    <html lang="es">
      <head>
        ...
        <title>
          {shipment
            ? `Seguimiento ${shipment.correosTrackingNumber} — Correos Express Pro`
            : "Seguimiento de envío — Correos Express Pro by Enviox"
          }
        </title>
          ...
          <header className="tracking-header">
            <div className="header-content">
              <div className="brand">
                ...
                <span className="brand-badge">CORREOS EXPRESS PRO</span>
              </div>
          ...
          <section className="search-section">
            <form method="GET" className="search-form">
              <input
                type="text"
                name="n"
                placeholder="Introduce tu número de seguimiento Correos Express..."
                value={inputValue}
          ...
          <main className="tracking-main">
              ...
              <>
                ...
                <div className="status-hero" style={{ borderColor: statusInfo.color }}>
                  ...
                  <div className="status-info">
                    ...
                    <p className="tracking-number">N.º seguimiento: <strong>{shipment.correosTrackingNumber}</strong></p>
                  </div>
                </div>
                ...
                <div className="details-grid">
                  <div className="detail-card">
                    ...
                    <div className="detail-row">
                      ...
                      <span className="detail-value">{SERVICE_NAMES[shipment.correosServiceCode || "63"] || "Paq 24"}</span>
                    </div>
                    <div className="detail-row">
            ...
            {!trackingNumber && (
              <div className="welcome">
                ...
                <h2>Rastrea tu envío Correos Express</h2>
