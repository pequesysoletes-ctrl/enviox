...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (!credentials?.verified) {
    return json({ error: "Credenciales Correos Express no configuradas" }, { status: 400 });
  }
  ...
  try {
    ...
    await prisma.shipment.create({
      data: {
        ...
        correosServiceCode: serviceCode || "63",
...
export default function NewShipment() {
  ...
  const [serviceCode, setServiceCode] = useState(config?.defaultService || "63");
                ...
                <Card background="bg-surface-secondary">
                  <BlockStack gap="400" inlineAlign="center">
                    <Text as="p" variant="bodySm" tone="subdued" alignment="center">
                      NÚMERO DE TRACKING CORREOS EXPRESS
                    </Text>
    ...
    return (
      <Page title="Crear envío manual" backAction={{ url: "/app/shipments" }}>
        <Layout>
          <Layout.Section>
            <Banner
              title="Conecta tu cuenta Correos Express primero"
              tone="warning"
              action={{ content: "Conectar Correos Express", url: "/app/settings/correos-express" }}
            >
              Necesitas verificar tus credenciales Correos Express antes de crear envíos.
            </Banner>
          </Layout.Section>
        </Layout>
      </Page>
  ...
  const serviceOptions = [
    { name: "Paq 24 (entrega 24h)", code: "63", price: "5,90€", delivery: "24h" },
    { name: "Paq 10 (antes 10:00)", code: "92", price: "14,90€", delivery: "Antes de las 10:00" },
    { name: "Paq 14 (antes 14:00)", code: "90", price: "9,90€", delivery: "Antes de las 14:00" },
    { name: "Paq 48 (entrega 48h)", code: "67", price: "4,50€", delivery: "48h" },
    { name: "ePaq 24 (eCommerce)", code: "93", price: "4,90€", delivery: "24h" },
  ];
          ...
          <Layout.Section>
            ...
            <InlineStack gap="300" align="end">
              ...
              <Button variant="primary" submit loading={isLoading} size="large">
                ▶ Crear envío en Correos Express
              </Button>
            </InlineStack>
          </Layout.Section>
        </fetcher.Form>
