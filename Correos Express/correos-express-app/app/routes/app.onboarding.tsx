 ...
 * Shows when a new shop installs the app and has no Correos Express credentials configured.
 * 
 * Steps:
 * 1. Welcome / overview
 * 2. Correos Express credentials
        ...
        <Layout.Section>
          <Card>
            <BlockStack gap="600">
                ...
                <BlockStack gap="400">
                  ...
                  <BlockStack gap="200">
                    <InlineStack gap="300" blockAlign="center">
                      ...
                      <BlockStack gap="050">
                        <Text as="p" variant="bodyMd" fontWeight="bold">Conecta tu cuenta Correos Express</Text>
              ...
              {/* Step 2: Correos Express credentials */}
              {step === 2 && (
                <BlockStack gap="400">
                  <Text as="h2" variant="headingLg">🔑 Credenciales Correos Express</Text>
                  <Text as="p" variant="bodyMd" tone="subdued">
                    Estas credenciales te las proporciona tu contrato Correos. Si no las tienes,
              ...
              {step === 3 && (
                <BlockStack gap="400">
                  ...
                  <BlockStack gap="300">
                    <Text as="p" variant="bodyMd" fontWeight="bold">Servicio Correos por defecto:</Text>
                    {[
                ...
                <BlockStack gap="400">
                  <Box padding="600" borderRadius="300" background="bg-surface-secondary">
                    <BlockStack gap="400" inlineAlign="center">
                      ...
                      <Text as="p" variant="bodyLg" alignment="center" tone="subdued">
                        Tu app Correos Express Pro está lista para enviar. Aquí tienes algunos accesos rápidos:
                      </Text>
                    </BlockStack>
                  </Box>
