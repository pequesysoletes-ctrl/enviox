...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const allShipments = await prisma.shipment.findMany({
    where: { shop },
    select: { correosServiceCode: true },
  });

  const serviceCounts: Record<string, number> = {};
  for (const s of allShipments) {
    const code = s.correosServiceCode || "63";
            ...
            <Card>
              <BlockStack gap="500" inlineAlign="center">
                ...
                <Text as="h1" variant="headingXl" alignment="center">
                  Bienvenido a Correos Express Pro
                </Text>
                <Text as="p" variant="bodyLg" alignment="center">
                  Automatiza tus envíos con Correos Express directamente desde Shopify
                </Text>
                ...
                <BlockStack gap="400">
                  <InlineStack gap="400" align="center">
                    <StepItem number={1} title="Conecta" description="Introduce tus credenciales Correos Express" active />
                ...
                <Text as="p" variant="bodyMd" alignment="center" tone="subdued">
                  Esta app conecta con tu contrato Correos Express. Necesitas las credenciales API de tu cuenta de empresa.
                </Text>

                <Button variant="primary" size="large" onClick={() => navigate("/app/settings/correos-express")}>
                  Conectar cuenta Correos Express
                </Button>

                <Button variant="plain" onClick={() => navigate("/app/settings/correos-express")}>
                  ¿Dónde encuentro mis credenciales Correos Express?
                </Button>
                <EnvioBrandFooter />
              </BlockStack>
            </Card>
    ...
    return (
      <Page title="Dashboard">
        <Layout>
          <Layout.Section>
            <Banner
              title="⚠ Verifica tu conexión Correos Express para empezar a crear envíos"
              tone="warning"
              action={{ content: "Verificar ahora", onAction: () => navigate("/app/settings/correos-express") }}
            />
          </Layout.Section>
        </Layout>
      </Page>
