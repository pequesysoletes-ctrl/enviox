...
/**
 * EnvioBrand — Branded header component for Correos Express Pro by Enviox
 * Shows the Enviox wordmark + "Correos Express Pro" badge
 * Uses Correos Express blue (#00529B) for brand accent
 */
...
const BRAND_STYLES = {
  ...
  badgeCorreos: {
    color: "#FFCC00", // Correos Express yellow
  } as React.CSSProperties,
  footerContainer: {
    display: "flex",
    alignItems: "center",
...
/** Main brand header: ENVIOX [Correos Express Pro] */
export function EnvioBrandHeader({ size = "default" }: { size?: "small" | "default" | "large" }) {
  ...
  return (
    <div style={BRAND_STYLES.container}>
      ...
      >
        <span style={BRAND_STYLES.badgeCorreos}>Correos Express</span> Pro
      </span>
    </div>
  );
}
...
/** Brand divider — Correos Express gradient */
export function BrandDivider() {
  return (
    <div
      style={{
        height: "3px",
        background: "linear-gradient(90deg, #00529B, #FFCC00, #00529B)",
        borderRadius: "2px",
        opacity: 0.6,
        margin: "4px 0",
      }}
...
/** Brand accent card background — Correos Express blue + yellow */
export function BrandAccentBar() {
  return (
    <div
      style={{
        height: "4px",
        background: "linear-gradient(90deg, #00529B, #FFCC00)",
