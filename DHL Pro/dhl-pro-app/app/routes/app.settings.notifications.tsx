...
export default function NotificationSettingsPage() {
  ...
  const statusEvents = [
    ...
    { key: "notifyOnPickedUp", label: "🚛 Recogido", desc: "Cuando DHL recoge el paquete" },
  ...
  return (
    ...
    >
      <Layout>
        ...
        <Layout.Section>
          <Banner tone="success" title="🎉 ¡WhatsApp Tracking — Exclusiva DHL Pro!">
            <p>
                  ...
                  <BlockStack gap="200">
                    ...
                    <Box padding="300" background="bg-surface" borderRadius="200" borderWidth="025" borderColor="border">
                      <Text as="p" variant="bodySm">
                        🏠 Tu Tienda: ¡Tu envío DHL-0123456789 sale hoy para entrega! Estate atento.
                        Seguimiento: https://enviox.es/tracking?n=DHL-0123456789
                      </Text>
                    </Box>
                    ...
                    <Box padding="300" borderRadius="200" borderWidth="025" borderColor="border">
                      <div style={{ background: "#DCF8C6", borderRadius: 8, padding: 12, fontSize: 13 }}>
                        ...
                        <p style={{ margin: "8px 0 0 0" }}>
                          ¡Buenas noticias, Juan! Tu envío <strong>DHL-0123456789</strong> <strong>sale hoy para entrega</strong>.
                        </p>
                        <p style={{ margin: "8px 0 0 0" }}>
