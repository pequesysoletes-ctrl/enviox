...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  for (const s of allShipments) {
    const code = s.correosServiceCode || "N";
  ...
  const serviceNames: Record<string, string> = {
    ...
    "U":  "DHL Express WW (doc)",
    "K":  "DHL Express 9:00",
    "E":  "DHL Express 12:00",
    "D":  "DHL Express WW (nondoc)",
            ...
            <Card>
              <BlockStack gap="500" inlineAlign="center">
                ...
                <Text as="h1" variant="headingXl" alignment="center">
                  Bienvenido a DHL Pro
                </Text>
                <Text as="p" variant="bodyLg" alignment="center">
                  Automatiza tus envíos con DHL Express directamente desde Shopify
                </Text>
                ...
                <BlockStack gap="400">
                  <InlineStack gap="400" align="center">
                    <StepItem number={1} title="Conecta" description="Introduce tus credenciales DHL Express" active />
                ...
                <Text as="p" variant="bodyMd" alignment="center" tone="subdued">
                  Esta app conecta con tu cuenta DHL Express. Necesitas el Site ID, password y número de cuenta de tu contrato.
                </Text>

                <Button variant="primary" size="large" onClick={() => navigate("/app/settings/dhl")}>
                  Conectar cuenta DHL Express
                </Button>

                <Button variant="plain" onClick={() => navigate("/app/settings/dhl")}>
                  ¿Dónde encuentro mis credenciales DHL?
                </Button>
                <EnvioBrandFooter />
              </BlockStack>
            </Card>
    ...
    return (
      <Page title="Dashboard">
        <Layout>
          <Layout.Section>
            <Banner
              title="⚠ Verifica tu conexión DHL Express para empezar a crear envíos"
              tone="warning"
              action={{ content: "Verificar ahora", onAction: () => navigate("/app/settings/dhl") }}
            />
          </Layout.Section>
        </Layout>
      </Page>
