 ...
 * This page is served as an App Proxy by Shopify at: tutienda.com/a/dhl/tracking
 */
  ...
  return (
    <html lang="es">
      <head>
        ...
        <title>
          {shipment
            ? `Seguimiento ${shipment.correosTrackingNumber} — DHL Pro`
            : "Seguimiento de envío — DHL Pro by Enviox"
          }
        </title>
          ...
          <header className="tracking-header">
            <div className="header-content">
              <div className="brand">
                ...
                <span className="brand-badge">DHL PRO</span>
              </div>
          ...
          <section className="search-section">
            <form method="GET" className="search-form">
              <input
                type="text"
                name="n"
                placeholder="Introduce tu número de seguimiento DHL..."
                value={inputValue}
          ...
          <main className="tracking-main">
                ...
                <div className="details-grid">
                  <div className="detail-card">
                    ...
                    <div className="detail-row">
                      ...
                      <span className="detail-value">{SERVICE_NAMES[shipment.correosServiceCode || "N"] || "DHL Express"}</span>
                    </div>
                    <div className="detail-row">
            ...
            {!trackingNumber && (
              <div className="welcome">
                ...
                <h2>Rastrea tu envío DHL Express</h2>
