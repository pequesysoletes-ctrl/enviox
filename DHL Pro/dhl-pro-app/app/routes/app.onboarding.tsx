 ...
 * Shows when a new shop installs the app and has no DHL credentials configured.
 * 
 * Steps:
 * 1. Welcome / overview
 * 2. DHL credentials
        ...
        <Layout.Section>
          <Card>
            <BlockStack gap="600">
                ...
                <BlockStack gap="400">
                  ...
                  <BlockStack gap="200">
                    <InlineStack gap="300" blockAlign="center">
                      ...
                      <BlockStack gap="050">
                        <Text as="p" variant="bodyMd" fontWeight="bold">Conecta tu cuenta DHL</Text>
              ...
              {/* Step 2: DHL credentials */}
              {step === 2 && (
                <BlockStack gap="400">
                  <Text as="h2" variant="headingLg">🔑 Credenciales DHL</Text>
                ...
                <BlockStack gap="400">
                  <Box padding="600" borderRadius="300" background="bg-surface-secondary">
                    <BlockStack gap="400" inlineAlign="center">
                      ...
                      <Text as="p" variant="bodyLg" alignment="center" tone="subdued">
                        Tu app DHL Pro está lista para enviar. Aquí tienes algunos accesos rápidos:
                      </Text>
                    </BlockStack>
                  </Box>
