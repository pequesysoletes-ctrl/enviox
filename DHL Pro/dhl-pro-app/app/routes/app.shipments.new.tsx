  ...
  try {
    ...
    await prisma.shipment.create({
      data: {
        ...
        correosServiceCode: serviceCode || "N",
...
export default function NewShipment() {
  ...
  const [serviceCode, setServiceCode] = useState(config?.defaultService || "N");
                ...
                <Card background="bg-surface-secondary">
                  <BlockStack gap="400" inlineAlign="center">
                    <Text as="p" variant="bodySm" tone="subdued" alignment="center">
                      NÚMERO DE TRACKING DHL EXPRESS
                    </Text>
    ...
    return (
      <Page title="Crear envío manual" backAction={{ url: "/app/shipments" }}>
        <Layout>
          <Layout.Section>
            <Banner
              title="Conecta tu cuenta DHL Express primero"
              tone="warning"
              action={{ content: "Conectar DHL", url: "/app/settings/dhl" }}
            >
              Necesitas verificar tus credenciales DHL antes de crear envíos.
            </Banner>
          </Layout.Section>
        </Layout>
      </Page>
  ...
  const serviceOptions = [
    { name: "DHL Express Domestic (24h)", code: "N", price: "8,90€", delivery: "24h" },
    { name: "DHL Express Worldwide", code: "P", price: "24,90€", delivery: "2-5 días" },
    { name: "DHL Express 9:00", code: "K", price: "34,90€", delivery: "Antes de las 9:00" },
    { name: "DHL Express 12:00", code: "E", price: "19,90€", delivery: "Antes de las 12:00" },
    { name: "DHL Economy Select", code: "H", price: "14,90€", delivery: "5-10 días" },
  ];
