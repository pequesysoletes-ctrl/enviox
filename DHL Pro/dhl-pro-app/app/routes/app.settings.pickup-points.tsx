 ...
 * - DHL API: GET /puntos-servicio to search points by CP/city
...
// Mock pickup points for development (real ones come from DHL API)
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (intent === "search") {
    ...
    // In production: call DHL API to search pickup points
