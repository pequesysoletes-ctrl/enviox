...
/**
 * EnvioBrand — Branded header component for DHL Pro by Enviox
 * Shows the Enviox wordmark + "DHL Pro" badge
 * Uses DHL red (#D40511) and yellow (#FFCC00) for brand accent
 */
...
/** Main brand header: ENVIOX [DHL Pro] */
export function EnvioBrandHeader({ size = "default" }: { size?: "small" | "default" | "large" }) {
  ...
  return (
    <div style={BRAND_STYLES.container}>
      ...
      >
        <span style={BRAND_STYLES.badgeCorreos}>DHL</span> Pro
      </span>
    </div>
  );
}
...
/** Brand divider — DHL warm gradient */
export function BrandDivider() {
  return (
    <div
      style={{
        height: "3px",
        background: "linear-gradient(90deg, #D40511, #FFCC00, #D40511)",
        borderRadius: "2px",
        opacity: 0.6,
        margin: "4px 0",
      }}
...
/** Brand accent card background — DHL red + yellow */
